  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="about-strip">
        <div className="about-strip-inner">
          ...
          <div className="about-stats-mini">
            ...
            <div className="stat-mini">
              <strong>500+</strong>
              <span>Families<br />Served</span>
            </div>
            <div className="stat-mini">
              <strong>4.9★</strong>
              <span>Google<br />Rating</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "How does payment work?", a: "We collect a small advance (₹200–₹500) at the time of booking to confirm your slot — this is fully refundable if you cancel at least 24 hours before your appointment. The remaining balance is paid directly to our team after the service is completed and you are satisfied. We accept UPI, cards, and cash. Your payment is processed securely through Razorpay." },
            ].map((item) => (
      ...
      <div className="trust-strip">
        <div className="trust-item">🔒 Secure Online Payment</div>
        <div className="trust-item">↩️ Free Cancellation</div>
        <div className="trust-item">✅ Pay Small Advance, Rest After Service</div>
        <div className="trust-item">🛡️ 100% Satisfaction Guarantee</div>
        <div className="trust-item">📞 Call Us Before Booking</div>
      </div>
      ...
      <footer className="footer-full">
        <div className="footer-inner">
          ...
          <div className="footer-col">
            ...
            <div className="footer-social">
              ...
              <a href="https://wa.me/917034455665" target="_blank" rel="noopener" aria-label="WhatsApp">
                <span style={{ fontSize: "20px", lineHeight: 1 }}>💬</span>
              </a>
              <a href="https://g.page/r/CcleanwarksGoogleReviews" target="_blank" rel="noopener" aria-label="Google Reviews">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact-list">
              <li><a href="tel:+917034455665">📞 70344 55665</a></li>
              <li>
                <a href="https://wa.me/917034455665?text=Hi%2C+I%27d+like+to+book+sofa+cleaning+in+Bangalore" target="_blank" rel="noopener">
                  💬 WhatsApp Us
                </a>
              </li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li>✅ 7+ Years in Cleaning Services</li>
              <li>✅ 500+ Happy Customers</li>
              <li>✅ 4.9 ★ Google Rating</li>
              <li>✅ Background-Verified Team</li>
        ...
        <div className="footer-bottom">
          <span>© 2026 Clean Warks. All rights reserved.</span>
          <span>
            <a href="https://cleanwarks.com/privacy-policy/">Privacy Policy</a>
            &nbsp;·&nbsp;
            <a href="https://cleanwarks.com/refund-policy/">Refund Policy</a>
          </span>
        </div>
      </footer>
